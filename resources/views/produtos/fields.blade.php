  ...
  <div class="col-sm-6">
    ...
    <div class="form-group col-sm-12 mb-3">
      ...
      <div class="w-75 pull-left">
        {!! Form::text('foto', null, ['class' => 'form-control', 'title' => 'Inserir link', 'placeholder' => 'Link para
        a foto do produto', 'id' => 'link-foto']) !!}
      </div>

      <div class="w-25 pull-right">
        <a id="btn-modal-foto" class="btn btn-small btn-primary text-light" data-toggle="modal"
